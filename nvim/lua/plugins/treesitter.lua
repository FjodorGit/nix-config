return {
  {
    ...
    config = function()
      ...
      require('nvim-treesitter').install({
        'regex', 'markdown', 'c', 'cpp', 'go', 'lua', 'markdown_inline',
        'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc',
        'vim', 'bash', 'julia', 'sql', 'java',
      })
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>Ap', function() swap.swap_previous('@parameter.inner') end)
    end,
  },
}
